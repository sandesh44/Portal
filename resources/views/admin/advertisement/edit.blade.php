        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form action="{{route('advertisement.update',$advertisement->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div>
                        <input type="text" class="form-control" placeholder="Advertisement Name" name="title" value="{{$advertisement->title}}" required>
                    </div>
                
                    <div class="sub-title">URL</div>
                    <div>
                        <input type="url" class="form-control" placeholder="URL" name="url" value="{{$advertisement->url}}" required>
                    </div>
